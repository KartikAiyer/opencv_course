...
int main( int argc, char** argv)
{
  ...
  deserialize(DATA_FOLDER "/models/common/shape_predictor_68_face_landmarks.dat") >> landmarkDetector;

  // File to copy wrinkles from
  string filename1 = DATA_FOLDER "/images/wrinkle2.jpg";

  // File to apply aging
  string filename2 = DATA_FOLDER "/images/ted_cruz.jpg";
