...
int main() {
  ...
  const std::string recModelPath = MODEL_FOLDER "/openface.nn4.small2.v1.t7";
  frontal_face_detector faceDetector = get_frontal_face_detector();
  dnn::Net recModel = dnn::readNetFromTorch(recModelPath);
  dlib::shape_predictor landmarkDetector;
  dlib::deserialize(MODEL_FOLDER "/shape_predictor_5_face_landmarks.dat") >> landmarkDetector;
  ...
  string faceDatasetFolder = IMAGE_FOLDER "/faces";
